...
<!-- <li><a href="testpage.jsp?query=whsakila">Sakila</a></li>  -->
<li><a href="testpage.jsp?query=whsales">Data Warehouse Sales</a></li>
<li><a href="testpage.jsp?query=whpurchasing">Data Warehouse Purchasing</a></li>
